...
export default function ThankYou() {
  return (
    ...
    >
      {/* Background Gradient */}
      <div className="absolute top-0 left-0 w-full md:w-3/5 h-full bg-gradient-to-b md:bg-gradient-to-r from-orange-100/80 via-orange-50/50 dark:from-orange-900/60 dark:via-orange-900/20 to-transparent pointer-events-none transition-colors duration-300" />
      ...
      <div className="relative z-10 w-full max-w-4xl pt-4 md:pt-0">
        <div className="relative inline-block mb-2 md:mb-12">
          ...
          <div className="absolute -bottom-6 md:-bottom-8 left-2 md:left-24 text-3xl md:text-6xl font-serif italic text-primary z-30 whitespace-nowrap transform -rotate-3 drop-shadow-md transition-colors duration-300" style={{ fontFamily: '"Brush Script MT", cursive' }}>
            For Your Attention
          </div>
        </div>
