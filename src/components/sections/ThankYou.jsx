    ...
    >
      ...
      <div className="relative md:absolute bottom-0 right-0 z-20 flex items-end justify-center md:justify-end w-full pointer-events-none -mt-4 md:mt-0 mix-blend-normal dark:mix-blend-lighten">
         <img 
           ...
           className="h-[350px] sm:h-[400px] md:h-[550px] lg:h-[650px] w-auto object-cover object-bottom relative z-20 md:mr-16 rounded-t-[150px] dark:rounded-none shadow-2xl dark:shadow-none bg-black dark:bg-transparent"
         />
